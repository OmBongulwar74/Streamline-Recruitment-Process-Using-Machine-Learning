		          ...
		          <div class="contact-form">
						...
						<%}%>
					    	<div>
						    	...
						    	<span><input  id="FNAME" type="text" placeholder="Firstff Name *" name="FirstName" required="required" data-validation-required-message="Please enter your name." maxlength="15" required="required" onblur="firstname()" class="textbox"></span>
						    ...
						    <div>
						       ...
						       <div>
						    	...
						    	<span><input  id="MNO" type="tel" placeholder="Your Phone *" name="Mobileno"  required="required" data-validation-required-message="Please enter your phone number."  maxlength="15" required="required" onblur="mobilenumber()" class="textbox"></span>
						    </div>
...
<%@include file="Footer.jsp"%>
	<script
		...
		<script type="text/javascript">
			jQuery(function($) {
				function init_map1() {
					var myLocation = new google.maps.LatLng(18.7471281,73.6856526);
					var mapOptions = {
						center : myLocation,
						zoom : 16
					};
