...
public class EMail {
	...
	public void sendMailFile(RegBean rb) {
		// TODO Auto-generated method stub
		// TODO Auto-generated method stub
		...
		try {	
	       ...
	       // props.put("mail.smtp.port", "587");
	        ...
	        //message.addRecipient(Message.RecipientType.TO, new InternetAddress(to));
	        message.addRecipient(Message.RecipientType.TO,toAddress);
	        message.setSubject("Your Password for file name " +rb.getFname());
	        message.setText("Hi User, "+"\n Thank you for registering with Cloud Portal .\nYour Filename :"+ rb.getFname() +" \n  Your Password :"+rb.getPassword()+" \n We appreciate your interest in our website.\n If you have any queries, please write to us at "+from+" \nRegards,\nCloud Portal");
	        Transport transport = session.getTransport("smtp");
	        transport.connect(host, from, pass);
	        message.saveChanges();
	        Transport.send(message,message.getAllRecipients());
