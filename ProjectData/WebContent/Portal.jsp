...
<form action="<%=request.getContextPath() %>/Business" method="post" enctype="multipart/form-data">              
	<div class="custom_file_upload" ><label style="text"><font color="#3C91E6">Resume Upload</font></label>
