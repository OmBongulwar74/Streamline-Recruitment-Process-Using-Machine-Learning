...
public final class DoctorRegistration_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<link href=\"../css/registration.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n");
      out.write("<script type=\"text/javascript\" src=\"../JavaScript/Registration.js\"></script>\r\n");
      out.write("<!-- Date Script  -->\r\n");
      out.write("\r\n");
      out.write("<link type=\"text/css\" href=\"../demoengine/demoengine.css\" rel=\"stylesheet\">\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"../demoengine/demoengine.js\" async defer></script>\r\n");
      out.write("\r\n");
      out.write("\t<link type=\"text/css\" href=\"http://ajax.googleapis.com/ajax/libs/jqueryui/1.9.2/themes/ui-\r\n");
      out.write("\r\n");
      out.write("darkness/jquery-ui.css\" rel=\"stylesheet\">\r\n");
...
if(isSuccess!=null)
 ...
 if(isSuccess!= null) 
      ...
      out.write("\t<p><strong>Note: Items marked * are required fields</p>\r\n");
      out.write("\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/RegistrationController\"  name=\"DoctorForm\" method=\"post\" >\r\n");
      out.write("\t<input type=\"radio\" class=\"Registrationinput\" name=\"UserType\" value=\"Patient\"  onclick=\"location.href='../JSP Pages/PatientRegistration.jsp?registration=true'\">Patient Registration</input>\r\n");
      out.write("\t<input type=\"radio\" class=\"Registrationinput\" name=\"UserType\" value=\"Doctor\" checked=\"checked\" onclick=\"location.href='../JSP Pages/DoctorRegistration.jsp?registration=true'\">Doctor Registration</input>\r\n");
      out.write("\t \r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<fieldset id=\"personal\">\r\n");
      out.write("\t\t\t\t\t<legend><span>Personal Details</span></legend>\r\n");
      out.write("\t\t\t\t\t<ol>\r\n");
      out.write("\t\t\t\t\t\t<li><label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">First Name<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" name=\"FirstName\" type=\"text\" id=\"firstname\" onblur=\"firstName();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"firstnameerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">Last Name<span>*</span></label>\t\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"lastname\" name=\"SurName\" onblur=\"Lastname();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"lastnameerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">Date of Birth<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"datepicker\" name=\"Date\" />\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"  name =\"Speciality\"class=\"Registrationlabelrequired\">Specialty<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<select class=\"Registrationinput\" >\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Addiction Medicine\">Addiction Medicine</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Bariatric Medicine\">Bariatric Medicine</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Cardiac Surgery\">Cardiac Surgery</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Dental Hygiene\">Dental Hygiene</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Electrodiagnostic Medicine\">Electrodiagnostic Medicine</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Hand Surgery\">Hand Surgery</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Independent Medical Examinations\">Independent Medical Examinations</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Obstetrics & Gynecology\">Obstetrics & Gynecology</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Pain Medicine\">Pain Medicine</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Vascular Medicine\">Vascular Medicine</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"Sleep Medicine\">Sleep Medicine</option>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t <label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">License number: <span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t \t<input class=\"Registrationinput\" type=\"text\" id=\"licensenumber\" name=\"LicenseNumber\" onblur=\"License();\"/>\r\n");
      out.write("\t\t\t\t\t\t \t<q id=\"licenseerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t\t<fieldset id=\"address\">\r\n");
      out.write("\t\t\t\t\t<legend><span>Address Details</span></legend>\r\n");
      out.write("\t\t\t\t\t<ol>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\" class=\"Registrationlabelrequired\">House Number &amp; Street<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"address1\" name=\"Address1\" onblur=\"House();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"houseerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">Town/City<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"address2\" name=\"Address3\" onblur=\"City();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"cityerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">Pincode<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"pincode\" name=\"PostCode\" maxlength=\"6\" onblur=\"Pincode();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"pincodeerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\t\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\" class=\"Registrationlabelrequired\">District</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"address3\" name=\"Address2\" onblur=\"District();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"districterror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">Country<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"address4\" name=\"Country\" onblur=\"Country();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"countryerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\">Mobile No</label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"phone\" name=\"Phone\" maxlength=\"10\" onblur=\"Mobile();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"mobileerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t\t\t<fieldset id=\"userdetails\">\r\n");
      out.write("\t\t\t\t\t<legend><span>Account Details</span></legend>\r\n");
      out.write("\t\t\t\t\t<ol>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"   class=\"Registrationlabelrequired\">Email id<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"emailid\" name=\"EmailID\" onblur=\"Emailvalidation();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"emailerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">Verify Email id<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" id=\"vemailid\" name=\"VEmailID\" onblur=\"Emailvalidation1();\"/>\r\n");
      out.write("\t\t\t\t\t\t\t<q id=\"vemailerror\" style=\"visibility:hidden;\"><font size=\"2\" color=\"red\"></font></q>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t\t<fieldset >\r\n");
      out.write("\t\t\t\t\t<input class=\"Registrationinput\" type=\"submit\"  value=\"Create Account\"/> <!--  onclick=\"createDoctorAccount();-->\r\n");
      out.write("\t\t\t\t\t<input class=\"Registrationinput\" type=\"button\"value=\"Reset\" onclick=\"DoctorReset();\"/>\r\n");
      out.write("\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t<script type=\"text/javascript\">\r\n");
      out.write("\t\t/*\r\n");
      out.write("\t\t * jQuery UI Datepicker: Parse and Format Dates\r\n");
      out.write("\t\t * http://salman-w.blogspot.com/2013/01/jquery-ui-datepicker-examples.html\r\n");
      out.write("\t\t */\r\n");
      out.write("\t\t$(function() {\r\n");
      out.write("\t\t\t$(\"#datepicker\").datepicker({\r\n");
      out.write("\t\t\t\tdateFormat: \"dd-mm-yy\",\r\n");
      out.write("\t\t\t\tonSelect: function(dateText, inst) {\r\n");
      out.write("\t\t\t\t\tvar date = $.datepicker.parseDate(inst.settings.dateFormat || \r\n");
      out.write("\r\n");
      out.write("$.datepicker._defaults.dateFormat, dateText, inst.settings);\r\n");
      out.write("\t\t\t\t\tvar dateText1 = $.datepicker.formatDate(\"D, d M yy\", date, \r\n");
      out.write("\r\n");
      out.write("inst.settings);\r\n");
      out.write("\t\t\t\t\tdate.setDate(date.getDate() + 7);\r\n");
      out.write("\t\t\t\t\tvar dateText2 = $.datepicker.formatDate(\"D, d M yy\", date, \r\n");
      out.write("\r\n");
      out.write("inst.settings);\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t}\r\n");
