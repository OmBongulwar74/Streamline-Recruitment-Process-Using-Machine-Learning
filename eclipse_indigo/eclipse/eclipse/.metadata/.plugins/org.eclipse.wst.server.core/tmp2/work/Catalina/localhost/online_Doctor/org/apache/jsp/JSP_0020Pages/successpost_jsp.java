...
public final class successpost_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Successfully Posted</title>\r\n");
      ...
      out.write("\t <link rel=\"stylesheet\" href=\"../css/framewarp.css\" />\r\n");
      out.write("\t \t\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=iso-8859-1\" />\r\n");
...
if(isSuccess!=null)
 ...
 if(isSuccess!= null) 
      ...
      out.write("\t\r\n");
      out.write("\t<fieldset >\r\n");
      out.write("\t\t\t\t\t<legend><span>Posted Successfully</span></legend>\r\n");
      out.write("\t\t\t\t\t<ol >\r\n");
      out.write("\t\t\t\t\t\t<li >\r\n");
      out.write("\t\t\t\t\t\t<a href=\"");
      out.print(request.getContextPath());
      out.write("/BussinessController?button=view&value=");
      out.print(session.getAttribute("query"));
      out.write("\"><font size=\"4px\"> ");
      out.print(session.getAttribute("query") );
      out.write("</font></a></li></ol>\r\n");
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t\t<ol><li>\r\n");
...
if(session!=null) {if("Patient".equals(session.getAttribute("userType"))){
      out.write("\r\n");
      out.write("\t\t\t\t<a href=\"../JSP Pages/postpage.jsp\"><input class=\"Registrationinput\" id=\"PostNew\"   type=\"button\"  value=\"New Post\"/></a>");
}else if("Doctor".equals(session.getAttribute("userType"))){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"../JSP Pages/commentWindow.jsp\" class=\"button1\" id=\"b2\"><input class=\"Registrationinput\" id=\"Comment\"   type=\"button\"  value=\"Comment\"/></a>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
}} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t <a href=\"");
      out.print(request.getContextPath());
      out.write("/BussinessController?button=viewallpost\"><input class=\"Registrationinput\" id=\"viewpost\"   type=\"button\"  value=\"View All Post\"/></a>\r\n");
      out.write("\t\t\t\t\t \r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
...
if(request.getSession(false)!=null)
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<fieldset >\r\n");
      out.write("\t\t\t\t\t<legend><span>View Post</span></legend>\r\n");
      out.write("\t\t\t\t\t<ol >\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<h2>");
      out.print(session.getAttribute("query") );
...
if(comments.size()==0)
		{
      out.write("\r\n");
      out.write("\t\t<h5> No comments yet</h5>\r\n");
      out.write("\t\t\r\n");
      out.write("\t");
}else{
	for(int i=0;i<comments.size();i++){ 
      ...
      out.write("        <script src=\"../js/jquerypp.custom.js\"></script>\r\n");
      out.write("        <script src=\"../js/framewarp.js\"></script>\r\n");
