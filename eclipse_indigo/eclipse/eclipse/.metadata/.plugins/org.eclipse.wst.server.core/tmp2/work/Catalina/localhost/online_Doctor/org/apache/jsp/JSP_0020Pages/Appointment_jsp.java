...
ArrayList<AppointmentDetail> appbean=(ArrayList<AppointmentDetail>)(session.getAttribute("appointmentlist")); 
      ...
      out.write("\tborder:1px solid #3f7f00;\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write(".CSSTableGenerator tr:nth-child(odd){ background-color:#d4ffaa; }\r\n");
      ...
      out.write("\t\tbackground:-o-linear-gradient(bottom, #5fbf00 5%, #3f7f00 100%);\tbackground:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #5fbf00), color-stop(1, #3f7f00) );\r\n");
      out.write("\tbackground:-moz-linear-gradient( center top, #5fbf00 5%, #3f7f00 100% );\r\n");
      out.write("\tfilter:progid:DXImageTransform.Microsoft.gradient(startColorstr=\"#5fbf00\", endColorstr=\"#3f7f00\");\tbackground: -o-linear-gradient(top,#5fbf00,3f7f00);\r\n");
      out.write("\r\n");
      out.write("\tbackground-color:#5fbf00;\r\n");
      out.write("\tborder:0px solid #3f7f00;\r\n");
...
if(appbean.size()>0){ 
      ...
      out.write("                        </td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("                            Start Time(in hrs)\r\n");
      out.write("                        </td>\r\n");
      out.write("                        <td>\r\n");
      out.write("                            Chat Option\r\n");
      out.write("                        </td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    ");
      ...
      out.write("                        <td >\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(appbean.get(i).getPatientName() );
      out.write("\r\n");
      out.write("                        </td>\r\n");
      out.write("                        <td>\r\n");
      out.write("                            \t\t");
      ...
      out.write("                        \r\n");
      out.write("                        ");
String startDate= (String)appbean.get(i).getStartTime();
                       
                        
      out.write("\r\n");
      out.write("                      <a href=\"");
      out.print(request.getContextPath());
      out.write("/ChatController?button=");
      out.print((i));
      out.write("&startDate=");
      out.print(appbean.get(i).getStartDate() );
      out.write("&endTime=");
      out.print(appbean.get(i).getStartTime());
      out.write("\">  <input type=\"button\"  value=\"Start Chat\"></a>\r\n");
      out.write("                        </td>\r\n");
      out.write("                        ");
} }
