...
ArrayList<String> chat=(ArrayList<String>) (session.getAttribute("Chat")); 
      ...
      out.write("function addChat()\r\n");
      out.write("{\r\n");
      out.write("\tdocument.getElementById(\"chatArea\").value += \"Me:\"+document.getElementById(\"chat\").value+\"\\n\";\r\n");
...
if(isSuccess!=null)
 ...
 if(isSuccess!= null) 
      ...
      out.write("<form action=\"");
      out.print(request.getContextPath());
      out.write("/ChatController\" method=\"post\" >\r\n");
      out.write("\t<fieldset >\r\n");
      out.write("\t\t\t\t\t<legend><span>Chat Application</span></legend>\r\n");
      out.write("\t\t\t\t\t<ol >\r\n");
      out.write("\t\t\t\t\t\t<li >\r\n");
      out.write("<textarea id=\"chatArea\" rows=\"8\" maxlength=\"1000\" cols=\"100\" style=\"font-size:15px;font-family:comic sans ms;width:100%; height:150%\" name=\"chat\" readonly=\"readonly\" \r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write(">\r\n");
...
for(int i=0;i<chat.size();i++){
      ...
      out.write("\t\t<ol><li>\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<input class=\"Registrationinput\" id=\"chat\" name=\"Chat\" type=\"text\" style=\"width: 90%\"/>\r\n");
      out.write("\t\t<input class=\"Registrationinput\" id=\"sendChat\"   type=\"Submit\"  value=\"Send\" onclick=\"addChat();\"/>\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("<input type=\"hidden\" name=\"fromemailid\" value=");
...
int i=Integer.parseInt(request.getParameter("button"));
      ...
      out.print(appbean.get(i).getStartDate());
      out.write(">\r\n");
      out.write("<input type=\"hidden\" name = \"endTime\" value=");
      out.print(appbean.get(i).getStartTime());
      out.write("> \r\n");
      out.write("<input type=\"hidden\" name=\"button\" value=");
      out.print(i);
      out.write(">\r\n");
      out.write("<input type=\"hidden\" name=\"button1\" value=send>\r\n");
      out.write("<input type=\"hidden\" name=\"toemailid\" value=");
      out.print(appbean.get(i).getDoctorName());
      out.write(">\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\r\n");
      out.write("</table>\r\n");
