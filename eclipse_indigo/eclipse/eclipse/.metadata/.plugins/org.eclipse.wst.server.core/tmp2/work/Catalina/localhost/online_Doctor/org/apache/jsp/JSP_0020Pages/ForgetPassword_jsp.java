...
if(isSuccess!=null)
 ...
 if(isSuccess!= null) 
      ...
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t<input type=\"hidden\" value=\"forget password\" name=\"button\">\r\n");
      out.write("\t\r\n");
      out.write("\t\t\t\t<fieldset >\r\n");
      out.write("\t\t\t\t\t<legend><span>Forget Password</span></legend>\r\n");
      out.write("\t\t\t\t\t<ol>\r\n");
      out.write("\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t");
String success=(String)session.getAttribute("fpassword");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<label><font size=\"3px\" color=\"red\">Incorrect Email id</font></label>\r\n");
      out.write("\t\t\t\t\t\t");
}
					else if ("true".equals(success))
					{
      out.write("\r\n");
      out.write("\t\t\t\t\t<label><font size=\"3px\" color=\"green\">Password send to your email id. Please check in Inbox or Spam</font></label>\r\n");
      out.write("\t\t\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<li><label class=\"Registrationlabel\"  class=\"Registrationlabelrequired\">Email id<span>*</span></label>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" name=\"Emailid\"  type=\"text\" id=\"emailid\" />\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<label class=\"Registrationlabel\" class=\"Registrationlabelrequired\">Verify Email id<span>*</span></label>\t\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"Registrationinput\" type=\"text\" id=\"VEmailid\" name=\"vemailid\" />\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</ol>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t<fieldset>\r\n");
      out.write("\t\t\t\t\t<input class=\"Registrationinput\"  style=\"text-align: right;\" type=\"submit\"  value=\"Get Password\"/>\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
