...
{
	 var vemail= document.getElementById("vemailid").value;
	    vemail=vemail.trim();
	    if (vemail.length==0)
	    	{
	    	  document.getElementById("vemailerror").innerHTML="Verify Email-Id  cannot be empty";
	 	      document.getElementById("vemailerror").style="visibility:visible;color:red";
	 	      document.getElementById("vemail").value="";
	 	      return false;
	    	}
	    var a=document.getElementById("emailid").value;
	    var b=document.getElementById("vemailid").value;
      ...
      if(a==b)
    	  ...
    	  {
    	     document.getElementById("vemailerror").innerHTML="Emailid not matched";
    	     document.getElementById("vemailerror").style="visibility:visible;color:red";
    	    return false;
    	  }
...
function House()
{
  ...
  var invalidChar1="~!@#$%^&*+?<>{}[]|";
    if(house.length==0)
    {
	   document.getElementById("houseerror").innerHTML="House No cannot be empty";
...
function PatientReset()
{
	...
	document.getElementById("vemailid").value="";
	document.getElementById("vemailerror").style="visibility:hidden";
...
function createPatientAccount()
{
	...
	alert("abc");
  if (firstName()==true && Lastname()==true && Mobile()==true && Pincode()==true && District()==true && Country()==true && City()==true && House()==true)
...
{
  if (firstName()==true && Lastname()==true && Mobile()==true && Pincode()==true && District()==true  && Country()==true && City()==true && House()==true && License()==true)
	  this.DoctorForm.submit();
	  else
		  return false;
}
